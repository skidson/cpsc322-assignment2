...
/**
 * Improves from the OrigEvaluator implementation by lowering the penalty for hard conflicts. In
 * this implementation, hard conflicts are penalized by 1000 per occurence, as opposed to Integer.MAX_VALUE.
 * This is considerably more helpful as two or more occurences of hard conflicts no longer result in an
 * integer overflow, triggering the sign bit, and indicating the result as optimal despite being far
 * from it.
 * @see Evaluator
 * @see OrigEvaluator
 */
